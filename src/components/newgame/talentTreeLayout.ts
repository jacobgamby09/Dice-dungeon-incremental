...
export const TALENT_TREE_LAYOUT: Record<TalentId, TalentTreePoint> = {
  ...
  [TALENT_IDS.shieldcraft]: { x: 820, y: 660 },
  [TALENT_IDS.thirdGrip]: { x: 940, y: 660 },
  [TALENT_IDS.healingArts]: { x: 820, y: 530 },
  [TALENT_IDS.towerDiscipline]: { x: 940, y: 530 },
  [TALENT_IDS.fourthGrip]: { x: 820, y: 400 },
  [TALENT_IDS.executionerDoctrine]: { x: 940, y: 400 },

  [TALENT_IDS.volatileTemper]: { x: 790, y: 850 },
  [TALENT_IDS.efficientTools]: { x: 790, y: 950 },
  [TALENT_IDS.faceMastery]: { x: 660, y: 900 },

  [TALENT_IDS.autoCombat]: { x: 850, y: 1010 },
  [TALENT_IDS.quickDraw]: { x: 780, y: 1120 },
  [TALENT_IDS.battleHardenedTwo]: { x: 920, y: 1120 },
  [TALENT_IDS.secondDescent]: { x: 850, y: 1190 },
